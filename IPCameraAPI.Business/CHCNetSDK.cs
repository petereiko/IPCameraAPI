...
namespace IPCameraAPI.Business
{
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public const int NET_DVR_SET_WIFI_CFG = 306;//ÉèÖÃIP_Éè±¸ÎÞÏß²ÎÊý
        public const int NET_DVR_GET_WIFI_CFG = 307;//»ñÈ¡IP_Éè±¸ÎÞÏß²ÎÊý
        public const int NET_DVR_SET_WIFI_WORKMODE = 308;//ÉèÖÃIP_Éè±¸Íø¿Ú¹¤×÷Ä£Ê½²ÎÊý
        public const int NET_DVR_GET_WIFI_WORKMODE = 309;//»ñÈ¡IP_Éè±¸Íø¿Ú¹¤×÷Ä£Ê½²ÎÊý 
        public const int NET_DVR_GET_WIFI_STATUS = 310;	//»ñÈ¡Éè±¸µ±Ç°wifiÁ¬½Ó×´Ì¬

        /***************************ÖÇÄÜ·þÎñÆ÷ begin *****************************/
        //ÖÇÄÜÉè±¸ÀàÐÍ
        public const int DS6001_HF_B = 60;//Òì³£ÐÐÎª¼ì²â£ºDS6001-HF/B
        public const int DS6001_HF_P = 61;//³µÅÆÊ¶±ð£ºDS6001-HF/P
        public const int DS6002_HF_B = 62;//Ë«»ú_£ºDS6002-HF/B
        public const int DS6101_HF_B = 63;//Òì³£ÐÐÎª¼ì²â£ºDS6101-HF/B
        ...
        public const int VCA_CHAN_ABILITY = 272;//Òì³£ÐÐÎª¼ì²âÄÜÁ¦
        ...
        public const int NET_DVR_SET_RULECFG = 152;//ÉèÖÃÒì³£ÐÐÎª¼ì²â¹æÔò
        public const int NET_DVR_GET_RULECFG = 153;//»ñÈ¡Òì³£ÐÐÎª¼ì²â¹æÔò
        ...
        public const int NET_VCA_GET_RULECFG_V41 = 5011; //»ñÈ¡Òì³£ÐÐÎª¼ì²â²ÎÊý
        public const int NET_VCA_SET_RULECFG_V41 = 5012; //ÉèÖÃÒì³£ÐÐÎª¼ì²â²ÎÊý
        ...
        public const int COMM_ALARM_RULE = 0x1102;//Òì³£ÐÐÎª¼ì²â±¨¾¯ÐÅÏ¢£¬¶ÔÓ¦NET_VCA_RULE_ALARM
        ...
        public const int COMM_SNAP_MATCH_ALARM = 0x2902;  //·Ç×¼ÈëÃûµ¥±È¶Ô½á¹ûÉÏ´«
        ...
        **************************************************/
        ...
        public const int WARNONMONITOR = 0x1;/*ÏÔÊ¾Æ÷ÉÏ¾¯¸æ*/
        ...
        public struct NET_DVR_DEV_CHAN_INFO
        {
            ...
            public byte[] byDomain;	//Éè±¸ÓòÃû
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] sUserName;	//_Ö÷»úµÇÂ½ÕÊºÅ
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = PASSWD_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] sPassword;	//_Ö÷»úÃÜÂë
        }
        ...
        public struct NET_DVR_DEVICEINFO_V40
        {
            ...
            public byte byPasswordLevel;      //adminÃÜÂë°²È«µÈ¼¶0-ÎÞÐ§£¬1-Ä¬ÈÏÃÜÂë£¬2-ÓÐÐ§ÃÜÂë,3-·çÏÕ½Ï¸ßµÄÃÜÂë¡£µ±ÓÃ»§µÄÃÜÂëÎª³ö³§Ä¬ÈÏÃÜÂë£¨_£©»òÕß·çÏÕ½Ï¸ßµÄÃÜÂëÊ±£¬ÉÏ²ã¿Í»§¶ËÐèÒªÌáÊ¾ÓÃ»§¸ü¸ÄÃÜÂë¡£      
        ...
        public struct NET_VCA_DEV_ABILITY
        {
            ...
            public byte bySupport;            //ÄÜÁ¦£¬Î»Óë½á¹ûÎª0±íÊ¾²»Ö§³Ö£¬1±íÊ¾Ö§³Ö
            //bySupport & 0x1£¬±íÊ¾ÊÇ·ñÖ§³ÖÖÇÄÜ_ 2012-3-22
            ...
            public byte byFSnapBFullChanNum;  //ÈËÁ³×¥ÅÄºÍÒì³£ÐÐÎª¼ì²âÍ¨µÀ¸öÊý
        ...
        {
            VCA_BEHAVIOR_BASE = 1,          //Òì³£ÐÐÎª¼ì²â»ù±¾°æ
            VCA_BEHAVIOR_ADVANCE = 2,          //Òì³£ÐÐÎª¼ì²â¸ß¼¶°æ
            VCA_BEHAVIOR_FULL = 3,          //Òì³£ÐÐÎª¼ì²âÍêÕû°æ
            VCA_PLATE = 4,          //³µÅÆÄÜÁ¦
            VCA_ATM = 5,          //ATMÄÜÁ¦
            VCA_PDC = 6,          //ÈËÁ÷Á¿Í³¼Æ
            VCA_ITS = 7,          //ÖÇÄÜ ½»Í¨ÊÂ¼þ
            VCA_BEHAVIOR_PRISON = 8,          //Òì³£ÐÐÎª¼ì²â¼àÓü°æ(¼àÉá) 
            ...
            VCA_BEHAVIOR_PRISON_PERIMETER = 13, // Òì³£ÐÐÎª¼ì²â¼àÓü°æ (ÖÜ½ç)
            VCA_TPS = 14,          //½»Í¨ÓÕµ¼
            VCA_TFS = 15,          //µÀÂ·Î¥ÕÂÈ¡Ö¤
            VCA_BEHAVIOR_FACESNAP = 16           //ÈËÁ³×¥ÅÄºÍÒì³£ÐÐÎª¼ì²âÄÜÁ¦
        }
        ...
        public struct NET_VCA_ONE_RULE
        {
            ...
            public VCA_EVENT_TYPE dwEventType;//Òì³£ÐÐÎª¼ì²âÊÂ¼þÀàÐÍ
            public NET_VCA_EVENT_UNION uEventParam;//Òì³£ÐÐÎª¼ì²âÊÂ¼þ²ÎÊý
        ...
        public struct NET_DVR_TRACK_CFG
        {
            ...
            public byte byDomeCalibrate;			//ÉèÖÃÖÇÄÜ_Çò»ú±ê¶¨£¬1ÉèÖÃ 0²»ÉèÖÃ 
            public byte byRes;					// ±£Áô×Ö½Ú
        ...
        {
            public uint dwSize;		//½á¹¹³¤¶È
            public byte byTrackMode;   //_Ä£Ê½
            public byte byRuleConfMode;   //¹æÔòÅäÖÃ_Ä£Ê½0-±¾µØÅäÖÃ_£¬1-Ô¶³ÌÅäÖÃ_
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;   //±£Áô£¬ÖÃ0
            [StructLayout(LayoutKind.Explicit)]
        ...
        public enum MAIN_EVENT_TYPE
        {
            ...
            EVENT_VCA_BEHAVIOR = 2,//Òì³£ÐÐÎª¼ì²â
        ...
        //Òì³£ÐÐÎª¼ì²âÖ÷ÀàÐÍ¶ÔÓ¦µÄ´ËÀàÐÍ£¬ 0xffff±íÊ¾È«²¿
        ...
        //Òì³£ÐÐÎª¼ì²â--°´Öµ·½Ê½²éÕÒ 
        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct EVENT_VCA_BYVALUE
        {
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.U2)]
            public ushort[] wChanNo;	//´¥·¢ÊÂ¼þµÄÍ¨µÀ			
            public byte byRuleID;      //Òì³£ÐÐÎª¼ì²âÀàÐÍ£¬¹æÔò0xff±íÊ¾È«²¿£¬´Ó0¿ªÊ¼
        ...
        public struct NET_DVR_VCA_CTRLINFO_CFG
        {
            ...
            public byte byVCAType;       //ÖÇÄÜÄÜÁ¦ÀàÐÍ£¬VCA_CHAN_ABILITY_TYPE 
            public byte byStreamWithVCA; //ÂëÁ÷ÖÐÊÇ·ñ´øÖÇÄÜÐÅÏ¢
            public byte byMode;			//Ä£Ê½£¬ATM ÄÜÁ¦Ê±²ÎÕÕVCA_CHAN_MODE_TYPE ,TFS ÄÜÁ¦Ê±²ÎÕÕ TFS_CHAN_MODE_TYPE£¬Òì³£ÐÐÎª¼ì²âÍêÕû°æÊ±²ÎÕÕBEHAVIOR_SCENE_MODE_TYPE
            public byte byControlType;   //¿ØÖÆÀàÐÍ£¬°´Î»±íÊ¾£¬0-·ñ£¬1-ÊÇ
                                         //byControlType &1 ÊÇ·ñÆôÓÃ×¥ÅÄ¹¦ÄÜ
        ...
        public struct NET_DVR_POSITION_RULE_CFG_V41
        {
            ...
            public byte byTrackEnable; //ÊÇ·ñÆôÓÃ_
            public byte byRes1;
            public ushort wTrackDuration; //_³ÖÐøÊ±¼ä£¬µ¥Î»s
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 76, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;         // ±£Áô×Ö½Ú
        }
        ...
        public struct NET_DVR_TRACK_PARAMCFG
        {
            ...
            public ushort wTrackHoldTime;     // ±¨¾¯_³ÖÐøÊ±¼ä  ·¶Î§0-300Ãë
            public byte byTrackMode;        //  ²ÎÕÕ IPDOME_TRACK_MODE
            public byte byPreDirection;	// _·½ÏòÔ¤ÅÐ 0-²»ÆôÓÃ 1-ÆôÓÃ
            public byte byTrackSmooth;	    // _Á¬Ðø  0-²»ÆôÓÃ 1-ÆôÓÃ
            public byte byZoomAdjust;	// ±¶ÂÊÏµÊýµ÷Õû ²Î¼ûÏÂ±í
            public byte byMaxTrackZoom;	//×î´ó_±¶ÂÊÏµÊý,0-±íÊ¾Ä¬ÈÏ±¶ÂÊÏµÊý,µÈ¼¶6-±ê¶¨Öµ*1.0(Ä¬ÈÏ),1-5ÎªËõÐ¡±ê¶¨Öµ£¬ÖµÔ½Ð¡£¬ËõÐ¡µÄ±ÈÀýÔ½´ó,7-15Îª·Å´ó£¬ÖµÔ½´ó£¬·Å´óµÄ±ÈÀýÔ½´ó
            public byte byStopTrackWhenFindFace;  //ÈËÁ³¼ì²âµ½ºóÊÇ·ñÍ£Ö¹_ 0-·ñ 1-ÊÇ
            public byte byStopTrackThreshold;   //_ÖÕÖ¹ÆÀ·ÖãÐÖµ
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 9, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;          //  ±£Áô×Ö½Ú                
        }
        ...
        public enum TRAFFIC_AID_TYPE
        {
            ...
            SMOKE = 0x20,    //ÑÌÎí  
            OVERLINE = 0x40,     //Ñ¹Ïß
            VEHICLE_CONTROL_LIST = 0x80,  //·Ç×¼ÈëÃûµ¥Êý¾Ý
            SPEED = 0x100  //³¬ËÙ
        }
        ...
        public enum ITS_ABILITY_TYPE
        {
            ...
            ITS_VEHICLE_CONTROL_LIST_ABILITY = 0x80,        //·Ç×¼ÈëÃûµ¥Êý¾Ý
        ...
        public struct NET_DVR_ONE_SCENE_CFG
        {
            ...
            public NET_DVR_PTZPOS struPtzPos;       //ptz ×ø±ê
            public uint dwTrackTime;              //Çò»ú_Ê±¼ä[5,300] Ãë£¬TFS(½»Í¨È¡Ö¤)Ä£Ê½ÏÂÓÐÐ§
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 24, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;               //±£Áô
        }
        ...
        public struct NET_DVR_PLATE_INFO
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_LICENSE_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byBelieve; //¸÷¸öÊ¶±ð×Ö·ûµÄÖÃÐÅ¶È£¬Èç¼ì²âµ½³µÅÆ"ÕãA_", ÖÃÐÅ¶ÈÎª,20,30,40,50,60,70£¬Ôò±íÊ¾"Õã"×ÖÕýÈ·µÄ¿ÉÄÜÐÔÖ»ÓÐ%£¬"A"×ÖµÄÕýÈ·µÄ¿ÉÄÜÐÔÊÇ%
        }
        ...
        public struct NET_DVR_WHITEBALANCE
        {
            public byte byWhiteBalanceMode; /*0-ÊÖ¶¯°×Æ½ºâ£¨MWB£©,1-×Ô¶¯°×Æ½ºâ1£¨AWB1£©,2-×Ô¶¯°×Æ½ºâ2 (AWB2),3-×Ô¶¯¿ØÖÆ¸ÄÃûÎªËø¶¨°×Æ½ºâ(Locked WB)£¬
	                         ...
	                         8-×Ô¶¯_(Auto-Track)9-Ò»´Î°×Æ½ºâ(One Push)£¬10-ÊÒÍâ×Ô¶¯(Auto-Outdoor)£¬
        ...
        {
            VCA_STANDARD92_PLATE = 0,//±ê×¼ÃñÓÃ³µÓëÌØÖÖ³µ
        ...
        public struct NET_MATRIX_RESOURSEGROUPPARAM
        {
            ...
            public byte byGroupType;/*0-ÉãÏñ»úCAM×é£¬1-ÏÔÊ¾Æ÷MON×é*/
            public byte byRes1;
        ...
        public struct NET_DVR_MATRIXMANAGE_ABIILITY
        {
            ...
            public uint dwMaxMonitorNum;//×î´óÏÔÊ¾Æ÷ÊýÁ¿
        ...
        {
            public byte byAgeGroup;    //ÄêÁä¶Î,²Î¼û HUMAN___GROUP_ENUM
            ...
            public byte byBeard;  //_, 0-²»Ö§³Ö£¬1-Ã»ÓÐ_£¬2-ÓÐ_£¬0xff-unknow±íÊ¾Î´Öª,Ëã·¨Ö§³ÖÎ´¼ì³ö
            public byte byRace;  //_, 0-²»Ö§³Ö£¬1-ÑÇÖÞÈË£¬2-_£¬3-_,0xff-unknow±íÊ¾Î´Öª,Ëã·¨Ö§³ÖÎ´¼ì³ö
        ...
        public struct NET_VCA_HUMAN_ATTRIBUTE
        {
            ...
            public byte byAgeGroup;//ÄêÁä¶Î£¬Ïê¼ûHUMAN___GROUP_ENUM£¬Èç´«Èë0xff±íÊ¾Î´Öª
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 11, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;//±£Áô
        }
        ...
        public struct NET_VCA_BLOCKLIST_PARA
        {
            ...
            public uint dwRegisterPicNum;  //·Ç×¼ÈëÃûµ¥Í¼¸öÊý
        ...
        public struct NET_VCA_BLOCKLIST_COND
        {
            public Int32 lChannel; //Í¨µÀºÅ
            public uint dwGroupNo; //·Ö×éºÅ
            public byte byType; //ºÚ×¼ÈëÃûµ¥±êÖ¾£º0-È«²¿£¬1-×¼ÈëÃûµ¥£¬2-·Ç×¼ÈëÃûµ¥
            public byte byLevel; //·Ç×¼ÈëÃûµ¥µÈ¼¶£¬0-È«²¿£¬1-µÍ£¬2-ÖÐ£¬3-¸ß
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;  //±£Áô
            public NET_VCA_HUMAN_ATTRIBUTE struAttribute; //ÈËÔ±ÐÅÏ¢
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
        ...
        public struct NET_VCA_FACESNAP_INFO_ALARM
        {
            ...
            public byte byAgeDeviation;//ÄêÁäÎó²îÖµ
            public byte byAgeGroup;//ÄêÁä¶Î£¬Ïê¼ûHUMAN___GROUP_ENUM£¬Èô´«Èë0xff±íÊ¾Î´Öª
        ...
        public struct NET_VCA_BLOCKLIST_INFO_ALARM
        {
            ...
            public uint dwBlockListPicLen;       //·Ç×¼ÈëÃûµ¥ÈËÁ³×ÓÍ¼µÄ³¤¶È£¬Îª0±íÊ¾Ã»ÓÐÍ¼Æ¬£¬´óÓÚ0±íÊ¾ÓÐÍ¼Æ¬
        ...
        public struct NET_VCA_FACESNAP_MATCH_ALARM
        {
            ...
            public NET_VCA_BLOCKLIST_INFO_ALARM struBlockListInfo; //·Ç×¼ÈëÃûµ¥ÐÅÏ¢
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
            public byte[] sStorageIP;        //´æ´¢·þÎñIPµØÖ·
            public ushort wStoragePort;            //´æ´¢·þÎñ¶Ë¿ÚºÅ
        ...
        public struct NET_VCA_FACESNAP_MATCH_ALARM_LOG
        {
            ...
            public NET_VCA_BLOCKLIST_INFO_ALARM_LOG struBlockListInfoLog; //·Ç×¼ÈëÃûµ¥ÐÅÏ¢
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 60, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;              // ±£Áô×Ö½Ú
        }
        ...
        public struct NET_VCA_FACEMATCH_PICCOND
        {
            ...
            public uint dwBlockListID; //Æ¥ÅäµÄ·Ç×¼ÈëÃûµ¥ID
            public uint dwBlockListFaceID; //±È¶ÔµÄ·Ç×¼ÈëÃûµ¥ÈËÁ³×ÓÍ¼ID
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;              // ±£Áô×Ö½Ú
        }
        ...
        public struct NET_VCA_FACEMATCH_PICTURE
        {
            ...
            public uint dwBlockListFaceLen; //±È¶ÔµÄ·Ç×¼ÈëÃûµ¥ÈËÁ³×ÓÍ¼³¤¶È
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;              //±£Áô×Ö½Ú
            public IntPtr pSnapFace;  //×¥ÅÄÈËÁ³×ÓÍ¼µÄÍ¼Æ¬Êý¾Ý
            public IntPtr pBlockListFace;  //±È¶ÔµÄ·Ç×¼ÈëÃûµ¥ÈËÁ³×ÓÍ¼Êý¾Ý
        }
        ...
        {
            public uint dwSize;   //½á¹¹´óÐ¡
            public NET_VCA_BLOCKLIST_INFO struBlockListInfo;  //·Ç×¼ÈëÃûµ¥»ù±¾²ÎÊý
        ...
        public struct NET_VCA_SINGLE_PATH
        {
            ...
            public byte byType;   //0-´æ´¢×¥ÅÄ£¬1-´æ´¢·Ç×¼ÈëÃûµ¥±È¶Ô±¨¾¯£¬2-´æ´¢×¥ÅÄºÍ·Ç×¼ÈëÃûµ¥±È¶Ô±¨¾¯£¬0xff-ÎÞÐ§
        ...
        public struct NET_ITS_PLATE_RESULT
        {
            ...
            //0-¿ªÕ¢£¬1-Î´¿ªÕ¢ (×¨ÓÃÓÚÀúÊ·Êý¾ÝÖÐÏà»ú¸ù¾ÝºÚ×¼ÈëÃûµ¥Æ¥Åäºó£¬ÊÇ·ñ¿ªÕ¢³É¹¦µÄ±êÖ¾)
        ...
        public struct NET_DVR_DIAGNOSIS_UPLOAD
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 64)]
            public string sMonitorIP;  ///< _µãip
            public uint dwChanIndex;  ///< _µãÍ¨µÀºÅ  
        ...
        public struct NET_DVR_ACS_EVENT_INFO
        {
            ...
            public byte byCardType; //¿¨ÀàÐÍ£¬1-ÆÕÍ¨¿¨£¬2-_¿¨£¬3-·Ç×¼ÈëÃûµ¥¿¨£¬4-Ñ²¸ü¿¨£¬5-Ð²ÆÈ¿¨£¬6-³¬¼¶¿¨£¬7-À´±ö¿¨£¬Îª0ÎÞÐ§
        ...
        public struct NET_DVR_ID_CARD_INFO
        {
            ...
            public byte byNation;    //_£¬1-"ºº"£¬2-"ÃÉ¹Å"£¬3-"»Ø",4-"²Ø",5-"Î¬Îá¶û",6-"Ãç",7-"ÒÍ",8-"×³",9-"²¼ÒÀ",10-"³¯ÏÊ",
        ...
        public struct NET_DVR_ID_CARD_INFO_ALARM
        {
            ...
            public uint dwPicDataLen;   //Í¼Æ¬Êý¾Ý´óÐ¡£¬²»Îª0ÊÇ±íÊ¾ºóÃæ´øÊý¾Ý
            public IntPtr pPicData;
            public byte byCardType; //¿¨ÀàÐÍ£¬1-ÆÕÍ¨¿¨£¬2-_¿¨£¬3-·Ç×¼ÈëÃûµ¥¿¨£¬4-Ñ²¸ü¿¨£¬5-Ð²ÆÈ¿¨£¬6-³¬¼¶¿¨£¬7-À´±ö¿¨£¬8-½â³ý¿¨£¬Îª0ÎÞÐ§
        ...
        public struct NET_DVR_CARD_CFG_V50
        {
            ...
            public byte byCardType; //¿¨ÀàÐÍ£¬1-ÆÕÍ¨¿¨£¬2-_¿¨£¬3-·Ç×¼ÈëÃûµ¥¿¨£¬4-Ñ²¸ü¿¨£¬5-Ð²ÆÈ¿¨£¬6-³¬¼¶¿¨£¬7-À´±ö¿¨£¬8-½â³ý¿¨£¬9-Ô±¹¤¿¨£¬10-Ó¦¼±¿¨£¬11-Ó¦¼±¹ÜÀí¿¨£¨ÓÃÓÚÊÚÈ¨ÁÙÊ±¿¨È¨ÏÞ£¬±¾Éí²»ÄÜ¿ªÃÅ£©£¬Ä¬ÈÏÆÕÍ¨¿¨
        ...
        public enum IVS_PARAM_KEY
        {
            ...
            MISSING_OBJECT_HOLD = 7,//Ä¿±êÏûÊ§ºó¼ÌÐø_Ê±¼ä
            MAX_MISSING_DISTANCE = 8,//Ä¿±êÏûÊ§ºó¼ÌÐø_¾àÀë
        ...
        public struct NET_DVR_LF_TRACK_MODE
        {
            ...
            public struct uModeParam
            {
                ...
                public uint[] dwULen;
                /*[FieldOffsetAttribute(0)]
                public NET_DVR_LF_MANUAL_CTRL_INFO struManualCtrl;//ÊÖ¶¯_½á¹¹
                [FieldOffsetAttribute(0)]
                public NET_DVR_LF_TRACK_TARGET_INFO struTargetTrack;//Ä¿±ê_½á¹¹
                 * */
            }
        }
        ...
        **********************************************************/
        [DllImport(@"C:\Swift Projects\CameraSolution\CameraSolution.WinApp\Dependencies\HCNetSDK.dll")]
        ...
        **********************************************************/
        ...
        [DllImport(@"C:\Swift Projects\CameraSolution\CameraSolution.WinApp\Dependencies\HCNetSDK.dll", CallingConvention = CallingConvention.Cdecl)]
        ...
        **********************************************************/
        ...
        [DllImportAttribute(@"C:\Swift Projects\CameraSolution\CameraSolution.WinApp\Dependencies\HCNetSDK.dll")]
        ...
        */
        ...
        public struct NET_VCA_PLATE_INFO
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = MAX_LICENSE_LEN)]
            public string sBelieve;//¸÷¸öÊ¶±ð×Ö·ûµÄÖÃÐÅ¶È£¬Èç¼ì²âµ½³µÅÆ"ÕãA_", ÖÃÐÅ¶ÈÎª10,20,30,40,50,60,70£¬Ôò±íÊ¾"Õã"×ÖÕýÈ·µÄ¿ÉÄÜÐÔÖ»ÓÐ10%£¬"A"×ÖµÄÕýÈ·µÄ¿ÉÄÜÐÔÊÇ20%
        }
